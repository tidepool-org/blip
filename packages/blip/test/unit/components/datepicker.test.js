...
describe("DatePickers", function () {
  ...
  describe("RangeDatePicker", function () {
    ...
    it("should render without problems", (done) => {
      ...
      const dt = <RangeDatePicker begin="2020-01-01T22:44:30.652Z" end={moment.utc("2020-01-07")} onChange={handleChange} />;
      ReactDOM.render(dt, container, () => {
