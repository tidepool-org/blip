...
import { MMOLL_UNITS, MS_IN_DAY } from "../js/data/util/constants";
...
describe("BGUtil", function() {
  ...
  describe("rangeBreakdown", function() {
    ...
    it("(on cbg data) should return Number.NaN for each component if less than threshold for complete day of data", function() {
      var d = new Date();
    ...
    it("(on smbg data) should return Number.NaN for each component if less than threshold for complete day of data", function() {
      var d = new Date();
      d = new Date(d.setUTCMilliseconds(0)).toISOString();
      var nextDay = dt.addDuration(d, MS_IN_DAY);
