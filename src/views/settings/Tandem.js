...
const Tandem = (props) => {
  ...
  const COLUMNS = [
    ...
    { key: 'rate', label: 'Basal Rates (U/hr)', className: styles.basalSchedulesHeader },
    { key: 'bgTarget', label: `BG Target (${bgUnits})`, className: styles.bolusSettingsHeader },
    { key: 'carbRatio', label: 'Insulin : Carb (g)', className: styles.bolusSettingsHeader },
    { key: 'insulinSensitivity', label: `Sensitivity (${bgUnits}/U)`, className: styles.bolusSettingsHeader },
  ];
