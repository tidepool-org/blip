...
describe('format utility', function() {
  ...
  describe('timeDiffInfo', function() {
    it('should be a function', function() {
      assert.isFunction(fmt.timeDiffInfo);
    });
    ...
    it('should error if 2 arguments are not passed', function() {
      ...
      expect(fmt.timeDiffInfo.bind(fmt)).to.throw(err);
      expect(fmt.timeDiffInfo.bind(fmt, x)).to.throw(err);
    });
