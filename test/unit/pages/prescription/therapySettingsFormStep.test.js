...
const meta = {
  training: { valid: true },
  initialSettings: {
    bloodGlucoseSuspendThreshold: { value: { valid: true } },
...
describe('therapySettingsFormStep', function() {
  ...
  it('should disable the complete button for any invalid fields', () => {
    ...
    expect(therapySettingsFormStep(invalidateMeta('initialSettings.bloodGlucoseSuspendThreshold.value')).disableComplete).to.be.true;
