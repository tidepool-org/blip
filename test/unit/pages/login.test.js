...
describe('Login', function () {
  ...
  describe('render', function() {
    it('should console.warn when required props are missing', function () {
      ...
      expect(console.warn.calledWith('Warning: Failed propType: Required prop `trackMetric` was not specified in `LoginNav`. Check the render method of `Login`.')).to.equal(true);
    });
