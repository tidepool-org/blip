...
import { showingShareDataBanner as reducer } from '../../../../app/redux/reducers/misc';

import * as actions from '../../../../app/redux/actions/index';

import { showingShareDataBanner as initialState } from '../../../../app/redux/reducers/initialState';

var expect = chai.expect;

describe('showingShareDataBanner', () => {
  describe('showBanner', () => {
    it('should set state to true', () => {
      let initialStateForTest = null;

      let action = actions.sync.showBanner('sharedata');
  ...
  describe('hideBanner', () => {
    it('should set state to null, but only if type matches', () => {
      ...
      let action = actions.sync.hideBanner('sharedata');
  ...
  describe('dismissBanner', () => {
    it('should set state to false', () => {
      ...
      let action = actions.sync.dismissBanner('sharedata');
  ...
  describe('fetchUserSuccess', () => {
    it('should set state to false if user clicked the banner', () => {
      ...
      const user = {
        preferences: {
          clickedShareDataBannerTime: 'today',
        },
      };
    ...
    it('should set state to false if user dismissed the banner', () => {
      ...
      const user = {
        preferences: {
          dismissedShareDataBannerTime: 'today',
        },
      };
