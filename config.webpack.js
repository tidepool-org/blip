...
const defineEnvPlugin = new webpack.DefinePlugin({
  ...
  __KEYCLOAK_URL__: JSON.stringify(process.env.KEYCLOAK_URL || null),
  __KEYCLOAK_REALM__: JSON.stringify(process.env.KEYCLOAK_REALM || null),
  __KEYCLOAK_CLIENTID__: JSON.stringify(process.env.KEYCLOAK_CLIENTID || null),
