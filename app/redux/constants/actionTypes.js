...
// consent.getLatestConsentByType
export const FETCH_LATEST_CONSENT_BY_TYPE_REQUEST = 'FETCH_LATEST_CONSENT_BY_TYPE_REQUEST';
export const FETCH_LATEST_CONSENT_BY_TYPE_SUCCESS = 'FETCH_LATEST_CONSENT_BY_TYPE_SUCCESS';
export const FETCH_LATEST_CONSENT_BY_TYPE_FAILURE = 'FETCH_LATEST_CONSENT_BY_TYPE_FAILURE';

// consent.getUserConsentRecords
export const FETCH_USER_CONSENT_RECORDS_REQUEST = 'FETCH_USER_CONSENT_RECORDS_REQUEST';
export const FETCH_USER_CONSENT_RECORDS_SUCCESS = 'FETCH_USER_CONSENT_RECORDS_SUCCESS';
export const FETCH_USER_CONSENT_RECORDS_FAILURE = 'FETCH_USER_CONSENT_RECORDS_FAILURE';

// consent.createUserConsentRecord
export const CREATE_USER_CONSENT_RECORD_REQUEST = 'CREATE_USER_CONSENT_RECORD_REQUEST';
export const CREATE_USER_CONSENT_RECORD_SUCCESS = 'CREATE_USER_CONSENT_RECORD_SUCCESS';
export const CREATE_USER_CONSENT_RECORD_FAILURE = 'CREATE_USER_CONSENT_RECORD_FAILURE';

// consent.updateUserConsentRecord
export const UPDATE_USER_CONSENT_RECORD_REQUEST = 'UPDATE_USER_CONSENT_RECORD_REQUEST';
export const UPDATE_USER_CONSENT_RECORD_SUCCESS = 'UPDATE_USER_CONSENT_RECORD_SUCCESS';
export const UPDATE_USER_CONSENT_RECORD_FAILURE = 'UPDATE_USER_CONSENT_RECORD_FAILURE';

// consent.revokeUserConsentRecord
export const REVOKE_USER_CONSENT_RECORD_REQUEST = 'REVOKE_USER_CONSENT_RECORD_REQUEST';
export const REVOKE_USER_CONSENT_RECORD_SUCCESS = 'REVOKE_USER_CONSENT_RECORD_SUCCESS';
export const REVOKE_USER_CONSENT_RECORD_FAILURE = 'REVOKE_USER_CONSENT_RECORD_FAILURE';
...
export const CLEAR_AUTHORIZED_DATA_SOURCE = 'CLEAR_AUTHORIZED_DATA_SOURCE';
export const SET_JUST_CONNECTED_DATA_SOURCE_PROVIDER_NAME = 'SET_JUST_CONNECTED_DATA_SOURCE_PROVIDER_NAME';
...
// clinics.getPatientsForClinic
export const FETCH_CLINIC_MRNS_FOR_PATIENT_FORM_VALIDATION_REQUEST = 'FETCH_CLINIC_MRNS_FOR_PATIENT_FORM_VALIDATION_REQUEST';
export const FETCH_CLINIC_MRNS_FOR_PATIENT_FORM_VALIDATION_SUCCESS = 'FETCH_CLINIC_MRNS_FOR_PATIENT_FORM_VALIDATION_SUCCESS';
export const FETCH_CLINIC_MRNS_FOR_PATIENT_FORM_VALIDATION_FAILURE = 'FETCH_CLINIC_MRNS_FOR_PATIENT_FORM_VALIDATION_FAILURE';
...
// clinics.setClinicPatientLastReviewed
export const SET_CLINIC_PATIENT_LAST_REVIEWED_REQUEST = 'SET_CLINIC_PATIENT_LAST_REVIEWED_REQUEST';
export const SET_CLINIC_PATIENT_LAST_REVIEWED_SUCCESS = 'SET_CLINIC_PATIENT_LAST_REVIEWED_SUCCESS';
export const SET_CLINIC_PATIENT_LAST_REVIEWED_FAILURE = 'SET_CLINIC_PATIENT_LAST_REVIEWED_FAILURE';

// clinics.revertClinicPatientLastReviewed
export const REVERT_CLINIC_PATIENT_LAST_REVIEWED_REQUEST = 'REVERT_CLINIC_PATIENT_LAST_REVIEWED_REQUEST';
...
// clinics.fetchClinicSites
export const FETCH_CLINIC_SITES_REQUEST = 'FETCH_CLINIC_SITES_REQUEST';
export const FETCH_CLINIC_SITES_SUCCESS = 'FETCH_CLINIC_SITES_SUCCESS';
export const FETCH_CLINIC_SITES_FAILURE = 'FETCH_CLINIC_SITES_FAILURE';

// clinics.createClinicSite
export const CREATE_CLINIC_SITE_REQUEST = 'CREATE_CLINIC_SITE_REQUEST';
export const CREATE_CLINIC_SITE_SUCCESS = 'CREATE_CLINIC_SITE_SUCCESS';
export const CREATE_CLINIC_SITE_FAILURE = 'CREATE_CLINIC_SITE_FAILURE';

// clinics.updateClinicSite
export const UPDATE_CLINIC_SITE_REQUEST = 'UPDATE_CLINIC_SITE_REQUEST';
export const UPDATE_CLINIC_SITE_SUCCESS = 'UPDATE_CLINIC_SITE_SUCCESS';
export const UPDATE_CLINIC_SITE_FAILURE = 'UPDATE_CLINIC_SITE_FAILURE';

// clinics.deleteClinicSite
export const DELETE_CLINIC_SITE_REQUEST = 'DELETE_CLINIC_SITE_REQUEST';
export const DELETE_CLINIC_SITE_SUCCESS = 'DELETE_CLINIC_SITE_SUCCESS';
export const DELETE_CLINIC_SITE_FAILURE = 'DELETE_CLINIC_SITE_FAILURE';

// clinics.fetchClinicPatientTags
export const FETCH_CLINIC_PATIENT_TAGS_REQUEST = 'FETCH_CLINIC_PATIENT_TAGS_REQUEST';
export const FETCH_CLINIC_PATIENT_TAGS_SUCCESS = 'FETCH_CLINIC_PATIENT_TAGS_SUCCESS';
export const FETCH_CLINIC_PATIENT_TAGS_FAILURE = 'FETCH_CLINIC_PATIENT_TAGS_FAILURE';
...
export const SMART_ON_FHIR_AUTH_SUCCESS = 'SMART_ON_FHIR_AUTH_SUCCESS';
export const SET_SMART_CORRELATION_ID = 'SET_SMART_CORRELATION_ID';
...
export const FETCH_RPM_REPORT_PATIENTS_SUCCESS = 'FETCH_RPM_REPORT_PATIENTS_SUCCESS';
export const FETCH_RPM_REPORT_PATIENTS_REQUEST = 'FETCH_RPM_REPORT_PATIENTS_REQUEST';
export const FETCH_RPM_REPORT_PATIENTS_FAILURE = 'FETCH_RPM_REPORT_PATIENTS_FAILURE';
export const CLEAR_RPM_REPORT_PATIENTS = 'CLEAR_RPM_REPORT_PATIENTS';

export const SET_SSO_ENABLED_DISPLAY = 'SET_SSO_ENABLED_DISPLAY';

export const FETCH_CLINIC_PATIENT_COUNTS_REQUEST = 'FETCH_CLINIC_PATIENT_COUNTS_REQUEST';
export const FETCH_CLINIC_PATIENT_COUNTS_SUCCESS = 'FETCH_CLINIC_PATIENT_COUNTS_SUCCESS';
export const FETCH_CLINIC_PATIENT_COUNTS_FAILURE = 'FETCH_CLINIC_PATIENT_COUNTS_FAILURE';
...
export const SET_CLINIC_UI_DETAILS = 'SET_CLINIC_UI_DETAILS';

export const SET_PENDO_DATA = 'SET_PENDO_DATA';

// Patient List Filters
export const SET_IS_PATIENT_LIST_VISIBLE = 'SET_IS_PATIENT_LIST_VISIBLE';
export const SET_PATIENT_LIST_SEARCH_TEXT_INPUT = 'SET_PATIENT_LIST_SEARCH_TEXT_INPUT';

// Navbar Chart Type
export const SET_NAVBAR_CHART_TYPE = 'SET_NAVBAR_CHART_TYPE';
