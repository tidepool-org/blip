...
export const ERR_FETCHING_PRESCRIPTIONS = t('Something went wrong while fetching your prescriptions.');
...
export const ERR_DELETING_CLINIC = t('Something went wrong while deleting clinic.');
...
export const ERR_ADDING_PATIENT_TO_CLINIC = t('Something went wrong while adding patient to clinic.');
...
export const ERR_ADDING_CLINICIAN_TO_CLINIC = t('Something went wrong while adding clinician to clinic.');
export const ERR_FETCHING_CLINICS_PATIENT = t('Something went wrong while fetching clinics patient.');
export const ERR_DELETING_CLINICS_PATIENT = t('Something went wrong while deleting clinics patient.');
export const ERR_FETCHING_CLINICS_CLINICIAN = t('Something went wrong while fetching clinics clinician.');
export const ERR_DELETING_CLINICS_CLINICIAN = t('Something went wrong while deleting clinics clinician.');
