...
export const ERR_CREATING_CUSTODIAL_ACCOUNT_LIMIT_REACHED = t('Can\'t add a new patient: Your workspace has reached the maximum number of patient accounts supported by our Base Plan. Please refresh your browser to see the updated patient count.');
