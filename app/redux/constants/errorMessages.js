...
export const ERR_FETCHING_MRNS_FOR_CLINIC = t('Something went wrong while fetching MRNs for clinic.');
export const ERR_FETCHING_MRNS_FOR_CLINIC_UNAUTHORIZED = t('Something went wrong with your account authorization. Please check with your administrator to verify your level of access.');
...
export const ERR_FETCHING_CLINIC_SITES = t('Something went wrong while fetching sites.');
...
export const ERR_FETCHING_CLINIC_PATIENT_TAGS = t('Something went wrong while fetching tags.');
...
export const ERR_FETCHING_CLINIC_PATIENT_COUNTS = t('Something went wrong while fetching the clinic patient counts.');
...
export const ERR_SMARTONFHIR_CLINICIAN_NOT_IN_CLINIC = t('You do not have access to the requested clinic.');
