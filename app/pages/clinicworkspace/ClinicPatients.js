...
import FilterByTagsPopoverContent from './components/FilterByTagsPopoverContent';
            ...
            {showSummaryData && (
              ...
              >
                ...
                <Flex sx={{ flexShrink: 0, gap: 2 }}>
                  ...
                  >
                    <FilterByTagsPopoverContent
                      tagOptions={sortedTagFilterOptions}
                      selectedTagIds={pendingFilters?.patientTags || []}
                      onChange={modifiedTags => {
                        setPendingFilters({ ...pendingFilters, patientTags: modifiedTags });
                      }}
                      onClear={() => {
