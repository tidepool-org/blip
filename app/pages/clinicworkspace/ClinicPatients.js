...
import ClinicPatientsTagDialog from './ClinicPatientTagsDialog';
...
export const ClinicPatients = (props) => {
  ...
  const renderClinicPatientTagsDialog = useCallback(() => {
    return (
      <ClinicPatientsTagDialog
        onUpdate={isClinicAdmin ? (id) => handleUpdateClinicPatientTag(id) : noop}
        onDelete={isClinicAdmin ? (id) => handleDeleteClinicPatientTag(id) : noop}
        onCreate={(tag, context) => {
