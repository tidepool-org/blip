  ...
  renderComment:function(comment){
    return (
      ...
      <div className='comment'>
        <span className='comment-header'> {comment.username} - {this.formatDisplayDate(comment.timestamp)}</span>
        <p className='comment-text'>{comment.messagetext}</p>
      </div>
      /* jshint ignore:end */
      );
  },
