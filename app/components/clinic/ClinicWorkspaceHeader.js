...
export const ClinicWorkspaceHeader = (props) => {
  ...
  const initialFetchedPatientCount = clinic?.initialFetchedPatientCount || 0;
              ...
              <Box>
                {clinic?.ui.display.patientCount && (
                  <Pill
                    ...
                    pt="2px"
                    pb={0}
                    text={`${initialFetchedPatientCount}${clinic.ui.display?.patientLimit ? ' / ' + clinic.patientCountSettings?.hardLimit?.patientCount : '' }`}
