...
export const Tooltip = styled.div`
  ...
  ${props => props.position.placement === 'bottom'
...
export const ZoneBadge = styled.span`
  ...
  padding: ${props => props.small ? '2px 6px' : '3px 8px'};
  border-radius: 4px;
  background-color: ${props => props.zoneColor || '#9ca3af'};
  color: #1f2937;
  font-weight: 700;
...
export const PercentileSection = styled.div`
  margin-top: 8px;
  padding-top: 8px;
  border-top: 1px solid rgba(255, 255, 255, 0.1);
  font-size: 11px;
